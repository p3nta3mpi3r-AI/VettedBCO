...
const replacement = `        {/* Mission commitment quote card */}
        <div className="mx-auto mt-12 bg-coffee-card bg-camo p-6 md:p-8 rounded-[2.5rem] border border-coffee-dark shadow-lg text-white flex flex-col md:flex-row items-center justify-between w-full max-w-[1133px] md:h-[333px] gap-6 overflow-hidden">
          ...
          <div className="flex-shrink-0 animate-pulse hover:scale-105 transition-all duration-300 cursor-pointer h-[150px] md:h-[250px] flex items-center justify-center">
            <img src="/250-year.png" alt="250 Year 1776-2026" className="h-full w-auto object-contain drop-shadow-2xl hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] transition-all duration-500" />
          </div>           
        </div>`;
